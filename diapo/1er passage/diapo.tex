...
\frame{{Plan}\tableofcontents[currentsection]}
	...
	\section{Préliminaire}
		...
		\begin{frame}{Lemme de Burnside}
			\begin{theorem}{\underline{Lemme de Burnside}\\}
				...
				\]
				où $\mid X/G \mid$ est le quotient de $X$ sous l'action de $G$ et \\$Fix(g) = \{x\in X, g.x = x\}$ est l'ensemble des éléments de X invariants par g.
			\end{theorem}
		\end{frame}
	...
	\section{En machine}
		...
		\begin{frame}{Polygones}
			...
			\begin{figure}
				\includegraphics[scale=0.3]{exemple_6_rot.eps}
				\includegraphics[scale=0.3]{exemple_6_rot_rot.eps}
			\end{figure}
		\end{frame}
\end{document}
